...
document.getElementById("sketch-to-draw").innerHTML = "Sketch To Be Drawn: "+sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function draw(){
 ...
 check_sketch(){
    if (drawn_sketch == sketch){
        answer_holder = "set" 
        score++;
        document.getElementById("score-span").innerHTML='Score: '+ score;
    }
}
}
...
function check_sketch(){
    timer_counter++;
    document.getElementById('timer-span').innerHTML='Timer'+ timer_counter;
